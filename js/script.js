  ...
  cards.forEach((card) => {
    ...
    singleCard.innerHTML = `
            ...
            <div class="flex items-center gap-x-2 text-secondary-color">
                ...
                <p> Birth: ${
                  card.date_of_birth ? card.date_of_birth : "Not Available"
                } </p>
            </div> 
            ...
            <div class="flex items-center gap-x-2 text-secondary-color mb-4">
                ...
                <p> Price: ${
                  card.price ? `${card.price}$` : "Not Available"
                } </p>
            </div> 
            ...
            <div class="cardButtons flex justify-between mt-4">
                <div>
                    <button onclick="showLikedPhotos('${
                      card.image
                    }')" id="" class="btn bg-transparent border-2 cardBtn"> <i class="fa-regular fa-thumbs-up"></i> </button>
                </div>

                <div>
                    <button onclick="loadAdoptModal(${
                      card.petId
                    })" id="card-btn-${
      card.petId
    }" class="btn bg-transparent border-2 adoptcardBtn"> Adopt </button>
                </div>

                <div>
                    <button onclick="loadDetails(${
                      card.petId
                    })" id="" class="btn bg-transparent border-2 cardBtn"> Details </button>
                </div>
            </div>
        `;
  ...
  detailsContainer.innerHTML = `
        ...
        <div class="grid grid-cols-2">
            <div class="flex items-center gap-x-2 text-secondary-color">
                <i class="fa-solid fa-border-all"></i>
                <p> Breed: ${
                  petInfo.breed ? petInfo.breed : "Not Available"
                } </p>
            </div> 
            ...
            <div class="flex items-center gap-x-2 text-secondary-color">
                <i class="fa-solid fa-venus"></i>
                <p> Gender: ${
                  petInfo.gender ? petInfo.gender : "Not Available"
                } </p>
            </div> 
